classdef commonDataStructure < matlab.mixin.SetGet & operationLogger
    ...
    methods
        ...
        function set.meta(cds,meta)
            ...
            elseif isempty(find(strcmp(meta.task,{'RW','CO','CObump','COactpas','BD','DCO','multi_gadget','UNT','RP','none','Unknown','SABES','UCK','OOR','WF','TRT','RT','RR','AFC'}),1))
