...
#%% Plot the liklihood values for all markers in 1 sec / 1 frame
...
for i in range(int(markers_section1.shape[1]/3)):
    #print(i)
    plt.scatter(float_markers_section1[:,i*3],float_markers_section1[:,i*3+1],s=500,marker=marker_list[i],c=float_markers_section1[:,i*3+2], cmap='RdYlGn',vmin=-1,vmax=1)
